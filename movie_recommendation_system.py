...
similarity =  pickle.load(open('D:/pythonProject/Movie_Recommendation/similarity.pkl','rb'))
movies_dict =  pickle.load(open('D:/pythonProject/Movie_Recommendation/movie_dict.pkl','rb'))
